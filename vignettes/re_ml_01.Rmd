...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Figure 1: Linear model evaluation", fig.align='center'}
eval_model(mod = mod_lm, df_train = daily_fluxes_train, df_test = daily_fluxes_test)
```

### KNN model evaluation

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Figure 2: KNN model evaluation", fig.align='center'}
