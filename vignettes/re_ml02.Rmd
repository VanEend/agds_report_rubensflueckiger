...
The function optimal_k_eval takes a training set and a test set as input. With the training set the function creates a KNN-model, searches for a ideal k-value and models the GPP value with this ideal k value. Afterwards the $R^2$ value and the RMSE value are calculated with the test set and returned. First value = $R^2$, second value = RMSE value.
...
|:--------------------------------------------|:-----:|:-----:|
| Evaluation against Davos test set           | 0.710 | 1.483 |
| Evaluation against Laegern test set         | 0.546 | 3.127 |
| Evaluation against Davos & Laegern test set | 0.610 | 2.170 |

| Model trained on data from Laegern          | $R^2$ | RMSE  |
|:--------------------------------------------|:-----:|:-----:|
| Evaluation against Davos test set           | 0.511 | 2.326 |
| Evaluation against Laegern test set         | 0.687 | 2.385 |
| Evaluation against Davos & Laegern test set | 0.599 | 2.295 |

| Model trained on data from Davos & Laegern  | $R^2$ | RMSE  |
|:--------------------------------------------|:-----:|:-----:|
| Evaluation against Davos test set           | 0.684 | 1.596 |
| Evaluation against Laegern test set         | 0.663 | 2.486 |
| Evaluation against Davos & Laegern test set | 0.666 | 1.963 |
